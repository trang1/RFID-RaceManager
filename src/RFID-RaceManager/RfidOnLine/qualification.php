...
<html lang="en">
  ...
  <body>
		  	...
		  	<div class="collapse navbar-collapse" id="navbarNav">
		  		<ul class="navbar-nav">
			      	...
			      	<li class="nav-item">
			        	...
			        	<a class="nav-link" href="qualification.php">QUALIFICAÇÕES</a>
			      	</li>
			      	<li class="nav-item">
    ...
    <div class="container mt-4">
    	<h5 class="mb-4 title"><strong>QUALIFICAÇÕES</strong></h5>
    	<div class="navigations sticky-top">
	    	<ul class="nav nav-pills nav-fill mb-4">
	    		<?php
	    	
			    	$rounds = $db->query("SELECT distinct re.Name FROM RaceEvents re where re.Name not in ('R','S','F')");
